...
public class Cola<T> {
     ...
     * Cola. <br>
     * <b>post: </b> Se elimina el primer elemento que fue insertado en la
     * cola.<br>
     *
     ...
     * <b>post: </b> Se elimino todos los datos que se encontraban en la
     * Cola.<br>
     */
    public void vaciar() {
     ...
     * Cola. <br>
     * <b>post: </b> Se obtiene el primer elemento que fue insertado en la
     * Cola.<br>
     *
     ...
     * <b>post: </b> Retorna si la Cola se encuentra vacia, retorna false si hay
     * elementos en la Cola.<br>
     *
     ...
     * <b>post: </b> Se retorno la representacion en String de la pila. El
     * String tiene el formato "e1->e2->e3..->en", donde e1, e2, ..., en son los
     * los elementos de la Pila. <br>
     *
