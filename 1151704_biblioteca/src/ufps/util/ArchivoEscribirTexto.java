...
public class ArchivoEscribirTexto {
     ...
     *
     * @param filename es un tipo String y contiene el nombre del archivo a
     * escribir
     * @param siDeseaAdd es un tipo boolean, true si se desea agregar o false
     * crear
     */
     ...
     *
     * @param msg es de tipo String y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo integer y contiene los datos que se desea incluir
     * en el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo float y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo byte y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo boolean y contiene los datos que se desea incluir
     * en el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo short y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo double y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     * Método que permite escribir en el archivo con salto de linea
     *
     * @param msg es de tipo char y contiene los datos que se desea incluir en
     * el archivo
     * @throws IOException Excepcion para controlar error de entrada al escribir
     * en el archivo
     */
     ...
     *
     * @param datos es de tipo T y contiene los datos que sera escritos en el
     * archivo
     * @return <T>
     */
     ...
     *
     * @return un String que contiene la informacion de la ruta absoluta del
     * archivo
     */
    public String ruta() {
